...
const experiences = [
  {
    ...
    date: "2024 - Present",
    details: [
      "Built a subscriber base of over <span style='color: white;'>x00,000 subscribers</span> by creating learning content to help programmers.",
      "Crafted visually appealling programming videos that have garnered over <span style='color: white;'>x0,000,000 views</span>.",
      "Produced high-quality educational and entertaining Materials for clients including <span style='color: white;'>Intel, JetBrains, and MicroCenter</span>.",
    ],
  },
  {
